#!/usr/bin/env python3
"""
Temperature System - Development Environment Launch

개발 환경용 Launch File입니다.
config/temperature_monitor_dev.yaml에서 설정을 읽어옵니다.
"""
...
def generate_launch_description():
    ...
    package_dir = get_package_share_directory('argos_bringup')

    # YAML 파일 경로 (개발 환경용)
    config_file = os.path.join(
        package_dir,
        'config',
        'temperature_monitor_dev.yaml'
    )
